...
function About_Home() {
  return (
    <div >
      <h1 > What are ontainers and why do you need them?</h1><hr />
      ...
      <h1>How do containers solve this problem?</h1><hr />
      <p > Put simply, a container consists of an entire runtime environment: an application, plus all its dependencies, libraries and other binaries, and configuration files needed to run it, bundled into one package. By containerizing the application platform and its dependencies, differences in OS distributions and underlying infrastructure are abstracted away.</p>
      <h1 >What’s the difference between containers and virtualization?</h1><hr />
      <img  src={require('./image/docker_vm_virtual.png')} alt="docker" /> <br /> <br />
      <p > With virtualization technology, the package that can be passed around is a virtual machine, and it includes an entire operating system as well as the application. A physical server running three virtual machines would have a hypervisor and three separate operating systems running on top of it.
        <br /><br />
      ...
      <h1 >What other benefits do containers offer?</h1><hr />
      <img  src={require('./image/benefits_of_containers.jpg')} alt="docker" /> <br /> <br />
      <p >A container may be only tens of megabytes in size, whereas a virtual machine with its own entire operating system may be several gigabytes in size. Because of this, a single server can host far more containers than virtual machines.
        <br /><br />
