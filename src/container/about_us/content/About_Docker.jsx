...
function About_Docker() {
    return (
        <div>
            <h1 className='itemContent'>What is Docker</h1> <hr />
            ...
            <h1 className='itemContent'>How Docker works ?</h1> <hr />
            ...
            <h1 className='itemContent'>Why use Docker?</h1><hr />
            <p className='itemContent incrseContentSize'>
                ...
                <br /> <br />
                <ul className='itemContent incrseContentSize'>
            ...
            <h1 className='itemContent'>Docker tools and terms</h1> <hr />
            <p className='itemContent incrseContentSize'>
                Some of the tools, terms and technologies developers encounter when using Docker include:
            </p>
            <h2 className='itemContent'>DockerFile</h2>
            <p className='itemContent incrseContentSize'>
            ...
            <h2 className='itemContent'>Docker images</h2>
            <p className='itemContent incrseContentSize'>
            ...
            <h2 className='itemContent'>Docker containers</h2>
            <p className='itemContent incrseContentSize'>
            ...
            <h2 className='itemContent'>Docker Hub</h2>
            <p className='itemContent incrseContentSize'>
            ...
            <h2 className='itemContent'> Docker Desktop</h2>
            <p className='itemContent incrseContentSize'>
            ...
            <h2 className='itemContent'>Docker daemon</h2>
            <p className='itemContent incrseContentSize'>
            ...
            <h2 className='itemContent'>Docker registry</h2>
            <p className='itemContent incrseContentSize'>
